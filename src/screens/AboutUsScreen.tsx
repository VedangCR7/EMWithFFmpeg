...
const AboutUsScreen: React.FC = () => {
  ...
  const dynamicStyles = StyleSheet.create({
    ...
    statsTitle: {
      ...
      color: theme.colors.text,
      textAlign: 'center',
      lineHeight: moderateScale(isTablet ? 22 * 1.45 : 20 * 1.45),
      textShadowColor: 'rgba(0, 0, 0, 0.1)',
      textShadowOffset: { width: 0, height: 1 },
      textShadowRadius: 2,
      includeFontPadding: false,
    ...
    statNumber: {
      ...
      lineHeight: moderateScale(isTablet ? 20 * 1.45 : 18 * 1.45),
    ...
    sectionTitle: {
      ...
      fontWeight: '800',
      color: theme.colors.text,
      lineHeight: moderateScale(isTablet ? 17 * 1.45 : 16 * 1.45),
      textShadowColor: 'rgba(0, 0, 0, 0.1)',
      textShadowOffset: { width: 0, height: 1 },
      textShadowRadius: 2,
      includeFontPadding: false,
    ...
    sectionText: {
      ...
      color: theme.colors.textSecondary,
      lineHeight: moderateScale(isTablet ? 14 * 1.4 : 13 * 1.4),
      fontWeight: '400',
      includeFontPadding: false,
    },
    featureList: {
    ...
    featureText: {
      fontSize: isTabletDevice ? getFontSize(8) : getFontSize(6.5),
      color: theme.colors.textSecondary,
      lineHeight: moderateScale(isTablet ? 12 * 1.4 : 14 * 1.4),
      flex: 1,
      fontWeight: '500',
      flexWrap: 'wrap',
      includeFontPadding: false,
    ...
    trialTitle: {
      ...
      color: theme.colors.text,
      textAlign: 'center',
      lineHeight: moderateScale(isTablet ? 18 * 1.45 : 17 * 1.45),
      textShadowColor: 'rgba(0, 0, 0, 0.1)',
      textShadowOffset: { width: 0, height: 1 },
      textShadowRadius: 2,
      includeFontPadding: false,
    ...
    versionText: {
      ...
      color: theme.colors.textSecondary,
      textAlign: 'center',
      lineHeight: moderateScale(isTablet ? 13 * 1.4 : 12 * 1.4),
      includeFontPadding: false,
    },
    privacyLink: {
      flexDirection: 'row',
    ...
    privacyLinkText: {
      ...
      fontWeight: '700',
      letterSpacing: 0.5,
      lineHeight: moderateScale(isTablet ? 14 * 1.6 : 13 * 1.6),
      paddingBottom: moderateScale(2),
    },
  });
